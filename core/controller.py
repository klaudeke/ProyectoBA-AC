...
class Controller:
    ...
    def mostrarTodoAnwo(self):
        listaBodega =[]
        lista = self.cliente.service.consultarProductosAnwo()
        for i in range(len(lista)):
            #id_producto,nombre,precio,stock,autor,vigencia
            producto = Banwo(
                            lista[i]['ID_PRODUCTO'],
    ...
    def actualizarStockAnwo(self,cod,stock):
        resultado = self.cliente.service.actualizarStockAnwo(cod,stock)
        return resultado
